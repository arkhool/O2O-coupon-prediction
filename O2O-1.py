...
ProcessDataSet1.to_csv('ProcessDataSet1.csv', index=None)
ProcessDataSet2 = DataProcess(dataset2, feature2, True)
ProcessDataSet2.to_csv('ProcessDataSet2.csv', index=None)
ProcessDataSet3 = DataProcess(dataset3, feature3, False)
ProcessDataSet3.to_csv('ProcessDataSet3.csv', index=None)
print('ProcessDataSet done')